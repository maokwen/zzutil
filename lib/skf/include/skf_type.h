...
typedef struct rsapubkeyblob_st 
{
	u32		AlgID;
	u32		BitLen;
	u8		Modulus[MAX_RSA_MODULUS_LEN];           //N
	u8		PublicExponent[MAX_RSA_EXPONENT_LEN];   //e
...
typedef struct rsaprivkeyblob_st 
{
	...
	u8		Modulus[MAX_RSA_MODULUS_LEN];           //N 
	u8		PublicExponent[MAX_RSA_EXPONENT_LEN];   //e
	u8		PrivateExponent[MAX_RSA_MODULUS_LEN];   //d
	u8		Prime1[MAX_RSA_MODULUS_LEN/2];          //p
	u8		Prime2[MAX_RSA_MODULUS_LEN/2];          //q
	u8		Prime1Exponent[MAX_RSA_MODULUS_LEN/2];  //dp
	u8		Prime2Exponent[MAX_RSA_MODULUS_LEN/2];  //dq
	u8		Coefficient[MAX_RSA_MODULUS_LEN/2];     //qinv
